  ...
  <div class="container">
      <div class="top-contact col-md-3 col-xs-12 col-sm-4">
        <?php if(esc_url( get_theme_mod( 'bb_ecommerce_store_contact','' ) ) != '') { ?>
          <span class="call"><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('bb_ecommerce_store_contact',__('(11) 99178-2694','bb-ecommerce-store') )); ?></span>
         <?php } ?>
      </div>
      <div class="top-contact col-md-3 col-xs-12 col-sm-4">
        <?php if(esc_url( get_theme_mod( 'bb_ecommerce_store_email','' ) ) != '') { ?>
          <span class="email"><i class="fa fa-envelope" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('bb_ecommerce_store_email',__('renebmjr@gmail.com','bb-ecommerce-store')) ); ?></span>
        <?php } ?>
      </div>
...
<!--    <div class="side_search col-md-6 col-sm-6 col-6 offset-md-2">
  ...
  <div class="col-md-9 col-sm-9">
    <?php 
    if ( !is_home() ) {
      echo do_shortcode('[rev_slider alias="slider-5"]'); 
    }
    ?>
  </div>
